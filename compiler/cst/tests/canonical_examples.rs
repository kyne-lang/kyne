//! Confirms `Cst::parse` produces zero diagnostics and a byte-perfect
//! lossless reconstruction for all six canonical example contracts, at
//! the `kyne_cst` wrapper layer specifically (`kyne_parser` has its own,
//! identical suite exercising the underlying tree directly).
